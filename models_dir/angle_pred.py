...
class Network(nn.Module):
    def __init__(self):
        ...
        self.fc1 = nn.Linear(512 * NETWORK_INPUT_RESIDUES_MAX, 128 * NETWORK_INPUT_RESIDUES_MAX)
        self.fc2 = nn.Linear(128 * NETWORK_INPUT_RESIDUES_MAX,  64 * NETWORK_INPUT_RESIDUES_MAX)
        self.fc3 = nn.Linear(64  * NETWORK_INPUT_RESIDUES_MAX,   4 * NETWORK_INPUT_RESIDUES_MAX)
    ...
    def generate_input(self, pssm, primary):
        ...
        for i in range(batch_size):
            for j in range(seq_len):
                residue = et_residue_index(primary[i, j])
